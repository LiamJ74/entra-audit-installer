# entra-audit-installer — DEPRECATED
...
This repo is kept for historical reference only. Future supply-chain or
install changes should land in
[coderaft-installer](https://github.com/LiamJ74/coderaft-installer).
